...
//		registry.addResourceHandler("freeBoardRegistration.html").addResourceLocations("classpath:/resources/");
//
//		List<String> imageFolders = Arrays.asList("email", "etc");
//		for (String imageFolder : imageFolders) {
//			registry.addResourceHandler("/static/img/" + imageFolder + "/**")
//					.addResourceLocations("file:///" + uploadImagesPath + imageFolder + "/").setCachePeriod(3600)
